    ...
    <>
      ...
      <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5  items-center justify-center flex-col">
          <img class="lg:w-2/6 md:w-3/6 w-5/6 mb-10 pb-5 object-cover object-center rounded" alt="hero" src="https://dummyimage.com/720x600" />
      ...
      <section class="text-gray-600 body-font">
        <div class="container px-5 py-12 mx-auto">
          ...
          <div class="flex flex-wrap mt-3 -m-4 text-center">
